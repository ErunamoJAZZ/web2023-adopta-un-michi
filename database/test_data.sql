...
-- Insert sample users
INSERT INTO michis."user" ("name", last_name, email, "password_hash", "user_type", birth_day, is_active, created_at)
VALUES
  ('John', 'Doe', 'john@example.com', '$2a$06$qzlZnLzQOOZcg1yNq42YAOo7mli3UOeAm7fpfR0H9HsPAuNCX/B4W', 'user_unal', '1990-01-15', true, NOW()),
  ('Jane', 'Smith', 'jane@example.com', '$2a$06$qzlZnLzQOOZcg1yNq42YAOo7mli3UOeAm7fpfR0H9HsPAuNCX/B4W', 'user_external', '1985-05-20', true, NOW()),
  ('Admin', 'Adminson', 'admin@example.com', '$2a$06$qzlZnLzQOOZcg1yNq42YAOo7mli3UOeAm7fpfR0H9HsPAuNCX/B4W', 'administrator', '1980-12-10', true, NOW());
